...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String TABLE_KETERANGAN = "CREATE TABLE "+ KeteranganDbSchema.KeteranganTable.TABLE_NAME+" (" +
            ...
            ""+ KeteranganDbSchema.KeteranganTable.Kolom.ID_LOKASI+" INTEGER NOT NULL," +
            ...
            " (id_alur), FOREIGN KEY (id_lokasi) REFERENCES " + LokasiDbSchema.LokasiTable.TABLE_NAME+
            " (id_lokasi))";
    ...
    public ContentValues contentValues(JSONObject jsonObject){
    ...
    public boolean isDataExist(String table, String id){
